...
function containerEnvironment(bindings) {
  ...
  return {
    ...
    MILK_STORE_KIND: "s3",
    MILK_STORE_REGION: bindings.MILK_STORE_REGION ?? "auto",
    MILK_STORE_PATH_STYLE: bindings.MILK_STORE_PATH_STYLE ?? "true",
    MILK_STORE_TIMEOUT_SECONDS: bindings.MILK_STORE_TIMEOUT_SECONDS ?? "30",
    ...
    MILK_ROUTE_POLL_SECONDS: bindings.MILK_ROUTE_POLL_SECONDS ?? "30",
